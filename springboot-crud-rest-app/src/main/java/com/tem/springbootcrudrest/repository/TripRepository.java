...
public interface TripRepository extends JpaRepository<TripSheet, Long> {
	...
	@Query(value = "select t From TripSheet t where t.truckno=:truckno and t.datetime between :fromdate and :todate")
	...
	public List<String> getListsBytrucknos();
	 ...
	 @Query(value="SELECT * FROM TripSheet t WHERE t.loadno=:loadno",nativeQuery=true) 
